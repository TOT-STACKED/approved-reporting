...
The data also includes Intelligence review data (the stackCollect key; "Intelligence" is what we now call what used to be StackCollect / tech stack reviews — always use the word "Intelligence" in your answers, never "StackCollect" or "stack review"). Each "review" is a submission from a hospitality venue showing which tech tools they use. The businessSubmissions array contains every venue that submitted a review — with their business name, industry, location, size, and number of locations. You can answer questions about specific venues, the most popular tools, POS market share, categories, and review counts. The toolUsageAnalytics and posMarketShare arrays contain pre-aggregated usage statistics.
